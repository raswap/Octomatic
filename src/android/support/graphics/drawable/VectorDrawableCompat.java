        ...
        private void drawPath(VGroup vgroup, VPath vpath, Canvas canvas, int i, int j, ColorFilter colorfilter)
        {
            ...
            if (f1 != 0.0F)
            {
                ...
                if (vpath.isClipPath())
                {
                    ...
                    canvas.clipPath(mRenderPath, android.graphics.Region.Op.REPLACE);
                    return;
                }
...
/*
        static Paint access$402(VPathRenderer vpathrenderer, Paint paint)
        {
...
/*
        static Paint access$502(VPathRenderer vpathrenderer, Paint paint)
        {
...
_L8:
    ...
    public void setBounds(int i, int j, int k, int l)
    {
        if (mDelegateDrawable != null)
        {
            mDelegateDrawable.setBounds(i, j, k, l);
            return;
        } else
        {
