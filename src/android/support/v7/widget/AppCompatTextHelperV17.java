...
class AppCompatTextHelperV17 extends AppCompatTextHelper
{
    ...
    void loadFromAttributes(AttributeSet attributeset, int i)
    {
        ...
        {
            mDrawableStartTint = createTintInfo(context, appcompatdrawablemanager, attributeset.getResourceId(0, 0));
        }
        if (attributeset.hasValue(1))
        {
            mDrawableEndTint = createTintInfo(context, appcompatdrawablemanager, attributeset.getResourceId(1, 0));
        }
