...
//            RtlSpacingHelper, TintTypedArray, AppCompatDrawableManager, ActionMenuView, 
//            ToolbarWidgetWrapper, ViewUtils, ActionMenuPresenter, DecorToolbar
...
_L12:
    ...
    {
        setLogo(mDrawableManager.getDrawable(getContext(), i));
    }
...
_L3:
    ...
    {
        setNavigationIcon(mDrawableManager.getDrawable(getContext(), i));
    }
