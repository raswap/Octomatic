...
//            TintTypedArray, AppCompatDrawableManager, AppCompatBackgroundHelper, ThemedSpinnerAdapter, 
...
_L4:
        if (i1 == 1)
        {
            ...
            mPopup = theme;
            mForwardingListener = new ListPopupWindow.ForwardingListener(theme) {
...
_L2:
        ...
        if (theme != null)
        {
            context = new ArrayAdapter(context, android.support.v7.appcompat.R.layout.support_simple_spinner_dropdown_item, theme);
