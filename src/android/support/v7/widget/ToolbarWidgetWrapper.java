...
//            DecorToolbar, Toolbar, TintTypedArray, AppCompatDrawableManager, 
    ...
    implements DecorToolbar
{
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean flag, int i, int j)
    {
        ...
        setDefaultNavigationIcon(mDrawableManager.getDrawable(getContext(), j));
...
label0:
    ...
    public void setIcon(int i)
    {
        ...
        if (i != 0)
        {
            drawable = mDrawableManager.getDrawable(getContext(), i);
        } else
        {
            drawable = null;
        }
    ...
    public void setNavigationIcon(int i)
    {
        ...
        if (i != 0)
        {
            drawable = AppCompatDrawableManager.get().getDrawable(getContext(), i);
        } else
        {
            drawable = null;
        }
