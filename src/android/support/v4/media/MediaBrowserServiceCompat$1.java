    ...
    implements Runnable
{
    ...
    public void run()
    {
        for (Iterator iterator = MediaBrowserServiceCompat.access$500(MediaBrowserServiceCompat.this).keySet().iterator(); iterator.hasNext();)
        {
            IBinder ibinder = (IBinder)iterator.next();
            nnectionRecord nnectionrecord = (nnectionRecord)MediaBrowserServiceCompat.access$500(MediaBrowserServiceCompat.this).get(ibinder);
            try
            {
            ...
            catch (RemoteException remoteexception)
            {
                ...
                MediaBrowserServiceCompat.access$500(MediaBrowserServiceCompat.this).remove(ibinder);
            }
        }
