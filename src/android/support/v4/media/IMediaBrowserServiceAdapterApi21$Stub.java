...
static abstract class attachInterface extends Binder
    implements IInterface
{
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            if (parcel.readInt() != 0)
            {
                parcel1 = (Bundle)Bundle.CREATOR.Stub(parcel);
            } else
            {
                parcel1 = null;
            }
            connect(s, parcel1, i21.Stub.asInterface(parcel.readStrongBinder()));
            return true;

        case 2: // '\002'
            parcel.enforceInterface("android.service.media.IMediaBrowserService");
            disconnect(i21.Stub.asInterface(parcel.readStrongBinder()));
            return true;

        case 3: // '\003'
            parcel.enforceInterface("android.service.media.IMediaBrowserService");
            addSubscription(parcel.readString(), i21.Stub.asInterface(parcel.readStrongBinder()));
            return true;

        case 4: // '\004'
            parcel.enforceInterface("android.service.media.IMediaBrowserService");
            removeSubscription(parcel.readString(), i21.Stub.asInterface(parcel.readStrongBinder()));
            return true;
        ...
        if (parcel.readInt() != 0)
        {
            parcel = (ResultReceiver)ResultReceiver.CREATOR.asInterface(parcel);
        } else
        {
            parcel = null;
        }
