...
_L1:
            MediaMetadataCompat mediametadatacompat1 = null;
_L4:
            return mediametadatacompat1;
_L2:
            if (mediametadatacompat.containsKey("android.media.metadata.ART"))
            {
                break; /* Loop/switch isn't completed */
            }
            mediametadatacompat1 = mediametadatacompat;
            if (!mediametadatacompat.containsKey("android.media.metadata.ALBUM_ART")) goto _L4; else goto _L3
_L3:
            android.support.v4.media.MediaMetadataCompat.Builder builder = new android.support.v4.media.MediaMetadataCompat.Builder(mediametadatacompat);
            ...
            if (mediametadatacompat != null)
            {
                builder.putBitmap("android.media.metadata.ALBUM_ART", mediametadatacompat.copy(mediametadatacompat.getConfig(), false));
            }
...
_L3:
        ...
        public void setMetadata(MediaMetadataCompat mediametadatacompat)
        {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 14)
            {
                ...
                if (mediametadatacompat != null)
                {
                    obj = cloneMetadataIfNeeded(mediametadatacompat);
                }
            }
            synchronized (mLock)
            {
